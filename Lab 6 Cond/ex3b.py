...
# Test cases
print(determine_progress2(0, 0))  # Expected: "Get going!"
print(determine_progress2(0, 5))  # Expected: "Get going!"
print(determine_progress2(1, 1))  # Expected: "Almost there!"
print(determine_progress2(2, 5))  # Expected: "On your way!"
print(determine_progress2(5, 10)) # Expected: "You win!"
