...
df_filtered_nonzero = df_filtered[df_filtered['sales price'] > 0]
print('\nFiltered DataFrame with non-zero sales:')
print(df_filtered_nonzero.head())

average_sales_price = df_filtered_nonzero['sales price'].mean()
print(f'\nAverage sales price: ${average_sales_price:,.2f}')